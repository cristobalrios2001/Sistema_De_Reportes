...
//Para la base de datos de extracciones (2)
config({path: '.env.db',})
const extraccionesEntities  = [FactorCarga,Rajo];
...
const DatabaseConfig : DataSourceOptions = {
    ...
    entities: [User,FactorCarga,Rajo],
...
export const AppExtracciones = new DataSource(DatabaseConfigDB)
/*
