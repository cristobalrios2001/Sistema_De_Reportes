...
const SolicitudesVisitas: React.FC = () => {
    ...
    return(
      <div className="flex h-screen w-full items-center bg-zinc-300 bg-cover text-xl">
        ...
        <div>
          ...
          <div class="container mx-auto ml-24 text-center">
            <div class="grid grid-cols-3 gap-16 my-0 mt-[-240px]">
              <div class="rounded-3xl bg-[#456570] w-100 px-5 py-3 text-white text-opacity-1000 shadow-xl backdrop-blur-md transition-colors">Visita</div>
              <div class="col-start-2 col-end-3 rounded-3xl bg-[#456570] w-100 px-16 py-3 text-white text-opacity-1000 shadow-xl backdrop-blur-md transition-colors">Aceptar</div>
              <div class="mt-[-8px] col-start-1 flex items-center rounded-3xl bg-[#456570] w-96 px-24 py-3 text-white text-opacity-1000 shadow-xl backdrop-blur-md transition-colors">nombre_1@minerals.cl</div>
...
export default SolicitudesVisitas