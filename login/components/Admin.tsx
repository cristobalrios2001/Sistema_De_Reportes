...
const Admin: React.FC = () => {
    ...
    return(
        ...
        <div className="flex h-screen w-full items-center bg-zinc-300 bg-cover text-xl">
          ...
          <div className="BarraIZQ absolut rounded-xl bg-[#384E55] ml-2 h-128 w-64 shadow-lg backdrop-blur-md max-sm:px-8 text-center">
            ...
            <div className="flex flex-col">
              <div className="flex flex-col mb-16">
                <button className="mt-7 bg-[#384E55] rounded-3xl px-10 py-2 text-white backdrop-blur-md transition-colors duration-300 hover:bg-[#47636b] backdrop-blur-md" onClick={() => router.push('profile')}>Reportes</button>
          ...
          <div className="flex flex-col items-center ml-32 bg-[#384E55] rounded-3xl py-16 px-24">
            <form action="#">
