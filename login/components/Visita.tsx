            ...
            <div className="text-white">
                ...
                <form action="#">
                    ...
                    <div className="mt-20 flex justify-flex text-lg text-black">                        
                        <button type="button" className="flex-shrink-0 rounded-3xl bg-sky-700 bg-opacity-20 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-sky-800 w-64" onClick={() => router.push("/")}>Enviar Solicitud</button>
                    </div>
                </form>
            </div>
        </div>
