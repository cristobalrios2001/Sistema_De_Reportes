...
const Profile: React.FC = () => {
    ...
    return(
        <div className="flex h-screen w-full items-center bg-zinc-300 bg-cover text-xl">
          <div className="BarraIZQ rounded-xl bg-[#384E55] ml-2 h-screen w-64 shadow-lg backdrop-blur-md max-sm:px-8 text-center">
          ...
          <div className="Botones flex flex-row ml-72 mt-5 absolute inset-x-0 top-0">
            <div className="ml-32">
              <button className="mr-5 rounded-3xl bg-[#384E55] px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-sky-800 backdrop-blur-md">Diario</button>
              <button className="mr-5 rounded-3xl bg-[#384E55] px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-sky-800 backdrop-blur-md">Semanal</button>
              <button className="mr-5 rounded-3xl bg-[#384E55] px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-sky-800 backdrop-blur-md">Semanal Cerrado</button>
              <button className="mr-5 rounded-3xl bg-[#384E55] px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-sky-800 backdrop-blur-md">Mensual</button>
              <button className="mr-5 rounded-3xl bg-[#384E55] px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-sky-800 backdrop-blur-md">Anual</button>
            </div>
          </div>
        </div>
    )
